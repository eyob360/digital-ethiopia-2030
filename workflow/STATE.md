...
- WO-0006 — re-validation failed (VAL-WO-0006): original failures 1/2/4 fixed; residual N2.AC1 defect — `Apply Document Budget` reads the count from `items[0]` and leaks across waves (one-line fix: use max of incoming counts)
